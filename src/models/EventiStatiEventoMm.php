...
/**
 * This is the model class for table "eventi_stati_evento_mm".
 */
class EventiStatiEventoMm extends \backend\models\base\EventiStatiEventoMm
{
...
//inserire il campo o i campi rappresentativi del modulo
     ...
     * pubblicazione creare la classe EventistatieventommQuery.php
...
//'destinatari' => 'Per i condominii',
    ...
    {
    $EventistatieventommQuery = new EventistatieventommQuery(get_called_class());
    $EventistatieventommQuery->andWhere('eventistatieventomm.deleted_at IS NULL');
    return $EventistatieventommQuery;
    }
    */
