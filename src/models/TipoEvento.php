...
*/
class TipoEvento extends \elitedivision\amos\eventi\models\base\TipoEvento
{
...
* pubblicazione creare la classe TipoeventoQuery.php
...
{
$TipoeventoQuery = new TipoeventoQuery(get_called_class());
$TipoeventoQuery->andWhere('tipoevento.deleted_at IS NULL');
return $TipoeventoQuery;
}
*/
