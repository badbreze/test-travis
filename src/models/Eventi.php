...
//use elitedivision\amos\eventi\models\query\EventiQuery;
...
*/
class Eventi extends \elitedivision\amos\eventi\models\base\Eventi
{
//const EVENTI_WORKFLOW = 'DiscussioniTopicWorkflow';

//public $regola_pubblicazione;
//public $destinatari;
//public $validatori;

            public $data_inizio_from;
            public $data_inizio_to;
                    public $data_fine_from;
            public $data_fine_to;
...
/*public function init()
    {
        parent::init();
        if ($this->isNewRecord) {
            $this->status = $this->getWorkflowSource()->getWorkflow(self::EVENTI_WORKFLOW)->getInitialStatusId();
        }
    }*/
...
* pubblicazione creare la classe EventiQuery.php
...
[['data_inizio'], 'date', 'format' => 'php:Y-m-d'],[['data_fine'], 'date', 'format' => 'php:Y-m-d'],]);
}
...
//'destinatari' => 'Per i condominii',
            'data_inizio_from' => 'Da data_inizio',
            'data_inizio_to'   => 'A  data_inizio',
                    'data_fine_from' => 'Da data_fine',
            'data_fine_to'   => 'A  data_fine',
        ]);
}
/*
...
[
    ...
    'defaultWorkflowId' => self::EVENTI_WORKFLOW,
...
{
$EventiQuery = new EventiQuery(get_called_class());
$EventiQuery->andWhere('eventi.deleted_at IS NULL');
return $EventiQuery;
}
*/
