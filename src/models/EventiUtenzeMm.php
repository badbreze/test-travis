...
/**
* This is the model class for table "eventi_utenze_mm".
*/
class EventiUtenzeMm extends \backend\models\base\EventiUtenzeMm
{
...
* pubblicazione creare la classe EventiutenzemmQuery.php
...
{
$EventiutenzemmQuery = new EventiutenzemmQuery(get_called_class());
$EventiutenzemmQuery->andWhere('eventiutenzemm.deleted_at IS NULL');
return $EventiutenzemmQuery;
}
*/
