...
/**
* This is the model class for table "stati_evento".
*/
class StatiEvento extends \elitedivision\amos\eventi\models\base\StatiEvento
{
...
* pubblicazione creare la classe StatieventoQuery.php
...
{
$StatieventoQuery = new StatieventoQuery(get_called_class());
$StatieventoQuery->andWhere('statievento.deleted_at IS NULL');
return $StatieventoQuery;
}
*/
