...
/**
* This is the model class for table "eventi_tipo_evento_mm".
*/
class EventiTipoEventoMm extends \backend\models\base\EventiTipoEventoMm
{
...
* pubblicazione creare la classe EventitipoeventommQuery.php
...
{
$EventitipoeventommQuery = new EventitipoeventommQuery(get_called_class());
$EventitipoeventommQuery->andWhere('eventitipoeventomm.deleted_at IS NULL');
return $EventitipoeventommQuery;
}
*/
